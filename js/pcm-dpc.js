    ...
    $.getJSON(
        ...
        function (dati_pcm_dpc) {
            ...
            $.each(dati_pcm_dpc, function (idx, obj) {
                ...
                totale_positivi.push(obj.totale_positivi);
                variazione_totale_positivi.push(obj.variazione_totale_positivi);
                dimessi_guariti.push(obj.dimessi_guariti);
                deceduti.push(obj.deceduti);
            });

            card_riassuntive(data, totale_casi, totale_positivi, dimessi_guariti, deceduti);
            graficoVariazioneGiornalieraContagi(data, variazione_totale_positivi);
            totaleContagiPerGiorno(data, totale_positivi);
        });
}

function card_riassuntive(data, totale_casi, totale_positivi, dimessi_guariti, deceduti) {
    totale_casi_oggi = totale_casi[totale_casi.length - 1];
    totale_positivi_oggi = totale_positivi[totale_positivi.length - 1];
    ...
    totale_positivi_ieri = totale_positivi[totale_positivi.length - 2];
    ...
    totale_positivi_differenza = totale_positivi_oggi - totale_positivi_ieri;
    ...
    document.getElementById("totale_positivi").innerHTML = totale_positivi_oggi;
    ...
    document.getElementById("totale_positivi_differenza").innerHTML = (totale_positivi_differenza > 0 ? "+" : "") + totale_positivi_differenza;
